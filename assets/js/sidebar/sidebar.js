...
const addTextBlockButton = document.getElementById(SELECTORS.addTextBlockButton)
...
const createFolderButton = document.getElementById(SELECTORS.createFolderButton)
...
const howRespondTextArea = document.getElementById(SELECTORS.howRespondTextArea)
...
document.addEventListener("DOMContentLoaded", () => {
  initEventListeners()
  initUI()
  const folders = JSON.parse(localStorage.getItem("promptBuilderFolders")) || []
  state.currentFolderId = folders.length > 0 ? folders[0].id : 0
})
